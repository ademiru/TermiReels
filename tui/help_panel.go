...
func (hp *HelpPanel) buildEntries() {
	...
	hp.entries = []helpEntry{
		...
		{displayKeys(config.KeysProfileOpen), "open creator reels"},
		{displayKeys(config.KeysProfileFollow), "follow / unfollow creator"},
		{displayKeys(config.KeysProfileBack), "return to main feed"},
